...
$output .= '<h3>'.get_field('search_title').'</h3>';
...
if( isset( $_GET['zip_search'] ) ) {
    $output .= "\t\t\t\t" . '<input id="wpsl-search-input" type="text" value="' . $_GET['zip_search'] . '" name="wpsl-search-input" placeholder="Enter City or Zip Code" aria-required="true" />' . "\r\n";
}
else {
$output .= "\t\t\t\t" . '<input id="wpsl-search-input" type="text" value="' . apply_filters( 'wpsl_search_input', '' ) . '" name="wpsl-search-input" placeholder="Enter City or Zip Code" aria-required="true" />' . "\r\n";
}
...
$output .= "\t\t\t\t" . '<div class="wpsl-search-btn-wrap"><input id="wpsl-search-btn" type="submit" value="FIND A LAB NEAR YOU"></div>' . "\r\n";
